...
import com.ayco.player.MusicService.MusicBinder;
import com.ayco.player.shared.MusicControllerFragment;
import com.ayco.player.shared.Song;
import com.ayco.player.tabs.TabPagerAdapter;
import com.ayco.player.tabs.TabPagerAdapter.Tabs;
import com.ayco.player.tabs.playlist.PlaylistFragment;
import com.ayco.player.util.Util;
import com.ayco.player.util.YesNoDialogFragment;
import com.ayco.player.util.YesNoDialogFragment.OnDeleteConfirmedListener;

import java.util.ArrayList;

public class MusicPlayerActivity extends AppCompatActivity implements OnDeleteConfirmedListener {

    public static final String PACKAGE_NAME = "com.ayco.player";
